...
const AdaSection = () => {
  ...
  return (
    <section className="bg-white">
      <div className="w-full bg-[#ffffff] rounded-b-[30px] md:rounded-b-[40px]">
        {/* Standard TeraStamp Padding */}
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-20 lg:px-8">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-6xl">
              ...
              >
                TeraStamp&apos;s{" "}
                <span style={{ color: "#F26418" }}>Ada</span>:
                <br />
                The first AI assistant created for infrastructure{" "}
                <span style={{ color: "#F26418" }}>monitoring</span>
              </h2>
          ...
          {/* Video */}
          <div className="mt-8 overflow-hidden rounded-[20px] shadow-lg">
            <div
              className="
                relative
                w-full
...
/* ================================================================
   ADA EXPLAINED – Steps with sticky media
   ================================================================ */
const adaSteps = [
  {
    id: "01",
      ...
      <div className="mx-auto max-w-7xl px-5">
        ...
        <div className="max-w-6xl">
          <h2 className="text-3xl font-bold text-black md:text-5xl">
            From Data to <span style={{ color: colors.accent }}>Understanding</span>
          </h2>

          <div className="mt-6 space-y-4 text-base leading-relaxed text-[#7C8595] md:text-xl">
            <p>
        ...
        <div className="mt-14 max-w-6xl">
          <h2 className="text-3xl font-bold text-black md:text-5xl">
            What is <span style={{ color: colors.accent }}>Ada?</span>
          </h2>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-28 flex gap-5">
              ...
              <div className="flex flex-col items-center">
                <span className="text-lg text-black">01</span>
                <div className="relative my-4 h-[420px] w-[4px] rounded-full bg-[#E2E8F0]">
                  <motion.div
                    style={{
                      height: fillHeight,
                    }}
                ...
                <span className="text-lg text-black">03</span>
              </div>
            ...
            {adaSteps.map((step, index) => (
              ...
              >
                <div className="w-full">
                  {/* Mobile Image – no border */}
                  <div className="mb-8 sm:mb-10 lg:hidden rounded-3xl overflow-hidden">
                    <img
                      src={step.image}
                      alt={step.title}
                      className="
                  ...
                  {/* Number */}
                  <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-[#F26418] text-2xl font-bold text-white">
                    {index + 1}
                  </div>

                  {/* Title */}
                  <h3 className="mt-5 text-2xl font-bold text-black md:text-4xl">
                    {highlightLastWord(step.title)}
                  </h3>

                  {/* Description */}
                  <p className="mt-4 max-w-2xl text-base leading-relaxed text-[#7C8595] md:text-lg">
                    {step.description}
                  </p>
                </div>
              </div>
...
/* ================================================================
   ADA INSIGHTS – 5 types of insights
   ================================================================ */
const insights = [
  {
    ...
    <section className="bg-white py-8 md:py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-6 lg:grid-cols-[420px_1fr] xl:grid-cols-[460px_1fr]">
          ...
          <div>
            {/* Heading */}
            <h2 className="text-2xl font-bold text-black sm:text-3xl md:text-4xl lg:text-[38px]">
              5 types of insights from <span style={{ color: colors.accent }}>Ada</span>
            </h2>

            {/* Description */}
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-[#7C8595] md:text-base">
              ...
              {insights.map((item, index) => (
                <button
                  ...
                  className={`
                    ...
                    border-2
                    ${active === index
                      ? "border-[#F26418] bg-[#F9FAFB] shadow-md"
                ...
                >
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-[#7C8595] md:text-base">
                    {item.description}
                  </p>
                </button>
              ))}
    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-20 lg:px-8">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="inline-flex rounded-xl border-2 border-[#F26418] bg-[#F26418]/10 px-4 py-2"
        >
        ...
        <motion.h2
          ...
          className="mt-5 max-w-3xl text-3xl font-bold leading-tight text-black md:text-4xl lg:text-5xl"
        >
          What makes Ada <span style={{ color: colors.accent }}>unique</span>
        </motion.h2>
          ...
          {benefits.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-center gap-4 rounded-[20px] border-2 border-[#F26418] bg-white px-4 py-4 transition-all duration-300 hover:bg-[#F9FAFB] hover:shadow-lg"
              >
                ...
                <p className="text-sm font-semibold leading-snug text-black md:text-base lg:text-lg">
                  {item.text}
                </p>
              </motion.div>
            );
...
/* ================================================================
   ADA CTA SECTION – centered "Discover the 'New' New" style
   ================================================================ */
const AdaCTASection = () => {
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-20 lg:px-8">
        <motion.div
          ...
          className="rounded-[32px] bg-[#F26418] px-8 py-12 md:px-16 md:py-16 lg:px-20 lg:py-20"
        >
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-4 text-lg font-medium text-white/80 sm:text-xl md:text-2xl">
    ...
    <section className="bg-white py-[50px]">
      <div className="mx-auto max-w-4xl px-5">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-black md:text-5xl">
            See TeraStamp's <span style={{ color: colors.accent }}>Ada</span> in action
          </h2>
          <p className="mt-5 text-lg italic text-[#7C8595] md:text-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-10 space-y-4">
          ...
          <label className="flex items-start gap-3">
            ...
            />
            <span className="text-sm leading-relaxed text-black md:text-lg">
